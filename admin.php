      ...
      <br>
       ...
       <div class="container">
        ...
        <figure class="text-center">
            ...
            <h6 class="lead" >Create a campaign</h6>
          </figure>
          <br>
          <div class="text-center">
          <a href="create.php"><button type="button" class="btn btn-primary position-relative">
            Create
          ...
          <br><br>
          <h6 class="lead text-center" >List of campaigns:</h6>
